 ...
 * 
 */
@WebServiceClient(name = "User", targetNamespace = "http://service.biblio.mairie.com/", wsdlLocation = "http://briceroro-Lenovo-IdeaPad-S340-15API:8080/WebService_biblio_p3/User?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USER_QNAME = new QName("http://service.biblio.mairie.com/", "User");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://briceroro-Lenovo-IdeaPad-S340-15API:8080/WebService_biblio_p3/User?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://service.biblio.mairie.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.biblio.mairie.com/", "UserServicePort"), UserService.class, features);
    }
